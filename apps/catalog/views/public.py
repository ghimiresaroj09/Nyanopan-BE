...
@extend_schema(
    ...
    description=(
        ...
        "- `model`: Filter by product model slug (e.g., `?model=celsi-wool-felt`)\n"
        ...
        "- `attribute`: Filter by attribute values - supports two formats:\n"
        "  - Name-based: `?attribute=color:grey&attribute=size:large`\n"
        "  - ID-based: `?attribute_{attr_id}={value_id}` (get IDs from /api/v1/attributes/)\n\n"
